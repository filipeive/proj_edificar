...
class PublicFormController extends Controller
{
    ...
    public function storeQuarterlyReport(Request $request)
    {
        $validated = $request->validate([
            ...
            // Health Indicators (Section IV)
            'discipleship_score' => 'nullable|integer|min:0|max:3',
            'evangelism_strategy' => 'nullable|integer|min:0|max:3',
            'consolidation_growth' => 'nullable|integer|min:0|max:3',
            'pastoral_score' => 'nullable|integer|min:0|max:3',
            'visitation_routine' => 'nullable|integer|min:0|max:3',
            'leader_support' => 'nullable|integer|min:0|max:3',
            'cell_participation_score' => 'nullable|integer|min:0|max:3',
            'service_participation_score' => 'nullable|integer|min:0|max:3',
            'tadium_participation' => 'nullable|integer|min:0|max:3',
            'communion_in_cells_score' => 'nullable|integer|min:0|max:3',
            'relationship_building_score' => 'nullable|integer|min:0|max:3',
            'prayer_intercession_score' => 'nullable|integer|min:0|max:3',
