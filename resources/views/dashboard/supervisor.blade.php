...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div
            ...
            <div class="flex items-center justify-between mb-4">
                <div class="bg-blue-50 p-4 rounded-2xl group-hover:bg-blue-600 transition-colors duration-500">
                    <i
                        class="bi bi-layers-fill text-blue-600 text-2xl group-hover:text-white transition-colors duration-500"></i>
                </div>
                <span class="text-[10px] font-black uppercase tracking-widest text-gray-400">Estrutura</span>
            </div>
            <div>
                <p class="text-gray-500 text-sm font-bold uppercase tracking-wider">Supervisão</p>
                <p class="text-3xl font-black text-gray-900 mt-2 tracking-tighter">{{ $supervisionName }}</p>
                <p class="text-xs text-gray-400 mt-2 font-bold uppercase tracking-widest">{{ $cells->count() }} Células
                    Ativas</p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                <p class="text-gray-500 text-sm font-bold uppercase tracking-wider">Total da Supervisão</p>
        ...
        <div
            ...
            <div>
                <p class="text-gray-500 text-sm font-bold uppercase tracking-wider">Taxa Geral</p>
                @php
                            ...
                            <tr class="hover:bg-gray-50 transition-colors group">
                                <td class="px-8 py-6">
                                    <div class="flex items-center">
                                        <div
                                            class="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center font-black mr-4 group-hover:bg-blue-600 group-hover:text-white transition-all">
                                            {{ strtoupper(substr($cell['name'], 0, 1)) }}
                                        </div>
                                        <span class="font-black text-gray-900">{{ $cell['name'] }}</span>
                                    </div>
                                </td>
