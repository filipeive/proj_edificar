...
@section('content')
    <div class="space-y-6 md:space-y-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div
                class="lg:col-span-2 bg-white rounded-3xl md:rounded-[2.5rem] shadow-sm border border-gray-100 p-5 md:p-8 h-fit">
                <div class="flex items-center justify-between mb-6 md:mb-8">
                    <div>
                        <h3 class="text-lg md:text-xl font-black text-gray-900 tracking-tight">Histórico Financeiro</h3>
                        <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">Últimos 6 Meses (MT)
                        </p>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="w-2.5 h-2.5 bg-blue-600 rounded-full"></span>
                        <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Contribuições</span>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl md:rounded-[2.5rem] shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 gap-3 md:gap-4">
                        <a href="{{ route('reports.zone') }}"
                            ...
                            <span
                                class="text-sm md:text-base font-black text-blue-900 group-hover:text-white transition-colors">Relatório
                                da Zona</span>
                        </a>
                        <a href="{{ route('cells.index') }}"
                            ...
                            <span
                                class="text-sm md:text-base font-black text-green-900 group-hover:text-white transition-colors">Listar
                                Células</span>
                        </a>
                        <a href="{{ route('contributions.index') }}"
                            ...
                            <span
                                class="text-sm md:text-base font-black text-orange-900 group-hover:text-white transition-colors">Contribuições</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    @forelse($recentCellMeetings as $meeting)
                        <div class="flex items-center space-x-6 group">
                            <div
                                class="bg-blue-50 px-4 py-3 rounded-2xl text-center min-w-[70px] group-hover:bg-blue-600 group-hover:text-white transition-colors">
                                <span
                                    class="block text-xl font-black leading-none">{{ $meeting->meeting_date->format('d') }}</span>
                                <span
                                    class="text-[10px] font-bold uppercase tracking-widest">{{ $meeting->meeting_date->translatedFormat('M') }}</span>
                            </div>
                            <div class="flex-1">
                            ...
                            <div class="text-right">
                                <span
                                    class="block font-black text-gray-900">{{ ($meeting->adults_count ?? 0) + ($meeting->children_count ?? 0) + ($meeting->visitors_count ?? 0) }}</span>
                                <span class="text-[8px] font-black uppercase tracking-widest text-gray-400">Total</span>
                            </div>
                        </div>
                    @empty
                        <p class="text-center text-gray-400 py-10 font-bold uppercase tracking-widest text-[10px]">Nenhuma
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8">
                ...
                <div class="space-y-6">
                    ...
                    @empty
                        <p class="text-center text-gray-400 py-10 font-bold uppercase tracking-widest text-[10px]">Nenhum evento
            ...
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8">
                ...
                <div class="space-y-6">
                    @forelse($recentServices as $service)
                        <div
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <h4 class="font-black text-gray-900">Culto de
                                        {{ $service->date->translatedFormat('l, d/m') }}</h4>
                    ...
                    @empty
                        <p class="text-center text-gray-400 py-10 font-bold uppercase tracking-widest text-[10px]">Nenhum
