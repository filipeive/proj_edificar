...
@section('content')
    <div class="space-y-6 md:space-y-8">
        <div class="hidden md:grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-2 font-bold uppercase tracking-widest">{{ $members->count() }}
                        Membros
                        Ativos</p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            <!-- Membros da Célula -->
            <div
                class="lg:col-span-2 bg-white rounded-3xl md:rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
                <div
                    class="px-5 md:px-8 py-4 md:py-6 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
                    <h3 class="text-lg md:text-xl font-black text-gray-900 tracking-tight">Membros da Célula</h3>
                ...
                <div class="bg-white rounded-3xl md:rounded-[2.5rem] shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 gap-3 md:gap-4">
                        <a href="{{ route('cells.attendance', $cell->id) }}"
                            ...
                            <span
                                class="text-sm md:text-base font-black text-blue-900 group-hover:text-white transition-colors">Ficha
                                Guia</span>
                        </a>
                        <a href="{{ route('cell-meetings.create') }}"
                            ...
                            <span
                                class="text-sm md:text-base font-black text-green-900 group-hover:text-white transition-colors">Novo
                                Encontro</span>
                        </a>
                        <a href="{{ route('reports.cell') }}"
                            class="flex items-center p-3 md:p-4 bg-purple-50 rounded-2xl hover:bg-purple-600 group transition-all duration-300">
                            <div
                                class="w-8 h-8 md:w-10 md:h-10 rounded-xl bg-white flex items-center justify-center text-purple-600 mr-3 md:mr-4 shadow-sm">
                                <i class="bi bi-file-earmark-bar-graph text-xl"></i>
                            </div>
                            <span
                                class="text-sm md:text-base font-black text-purple-900 group-hover:text-white transition-colors">Relatório
                                Célula</span>
                        </a>
                    </div>
                </div>
