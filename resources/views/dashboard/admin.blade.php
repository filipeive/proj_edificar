...
@section('content')
    <div class="space-y-6 md:space-y-8">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-4">
                ...
                <a href="{{ route('edificar.dashboard') }}"
                    class="bg-blue-600 p-3 md:p-4 rounded-2xl border border-blue-600 shadow-lg shadow-blue-200 hover:shadow-xl hover:bg-blue-700 transition-all text-center group">
                    <div
                ...
                <a href="{{ route('events.create') }}"
                    class="bg-white p-3 md:p-4 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all text-center group">
                    <div
                        class="w-8 h-8 md:w-10 md:h-10 bg-orange-50 rounded-xl flex items-center justify-center text-orange-600 mx-auto mb-2 md:mb-3 group-hover:bg-orange-600 group-hover:text-white transition-colors">
                        <i class="bi bi-calendar-plus"></i>
                    </div>
                    <span class="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-gray-600">Novo
                        Evento</span>
                </a>
                <a href="{{ route('services.create') }}"
                    class="bg-white p-3 md:p-4 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all text-center group">
                    <div
                        class="w-8 h-8 md:w-10 md:h-10 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 mx-auto mb-2 md:mb-3 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                ...
                <a href="{{ route('users.create') }}"
                    class="bg-white p-3 md:p-4 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all text-center group">
                    <div
                        class="w-8 h-8 md:w-10 md:h-10 bg-green-50 rounded-xl flex items-center justify-center text-green-600 mx-auto mb-2 md:mb-3 group-hover:bg-green-600 group-hover:text-white transition-colors">
                ...
                <a href="{{ route('cells.create') }}"
                    class="bg-white p-3 md:p-4 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all text-center group">
                    <div
                        class="w-8 h-8 md:w-10 md:h-10 bg-purple-50 rounded-xl flex items-center justify-center text-purple-600 mx-auto mb-2 md:mb-3 group-hover:bg-purple-600 group-hover:text-white transition-colors">
                        <i class="bi bi-diagram-3"></i>
                    </div>
                    <span class="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-gray-600">Nova
                        Célula</span>
                </a>
                <a href="{{ route('quarterly-reports.create') }}"
                    class="bg-white p-3 md:p-4 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all text-center group">
                    <div
                        class="w-8 h-8 md:w-10 md:h-10 bg-red-50 rounded-xl flex items-center justify-center text-red-600 mx-auto mb-2 md:mb-3 group-hover:bg-red-600 group-hover:text-white transition-colors">
                        <i class="bi bi-file-earmark-bar-graph"></i>
                    </div>
                    <span class="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-gray-600">Relat.
                        Trimestral</span>
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <!-- Members by Zone -->
            <div class="bg-white rounded-3xl md:rounded-[2.5rem] shadow-sm border border-gray-100 p-5 md:p-8">
                <h3 class="text-lg md:text-xl font-black text-gray-900 tracking-tight mb-6 md:mb-8">Membros por Zona</h3>
            ...
            <div class="bg-white rounded-3xl md:rounded-[2.5rem] shadow-sm border border-gray-100 p-5 md:p-8">
                <h3 class="text-lg md:text-xl font-black text-gray-900 tracking-tight mb-6 md:mb-8">Estrutura (Células e
                    Supervisões)</h3>
                <div class="h-[350px] relative">
        ...
        <!-- Mapa da Obra -->
        <div
            class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-gray-100 flex flex-col h-[600px] overflow-hidden group">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <div
                        class="flex items-center gap-2 text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] mb-2">
                        <i class="bi bi-map-fill"></i>
                        <span>Expansão do Reino</span>
                    </div>
                    <h2 class="text-3xl font-black text-gray-900 tracking-tighter">Mapeamento Geográfico</h2>
                </div>
            </div>

            <!-- Placeholder Ilustrativo do Mapa -->
            <div
                class="flex-1 bg-gray-50 rounded-[2rem] border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-center p-12 relative overflow-hidden group/map transition-all hover:bg-gray-100/50">
                <div class="relative z-10">
                    <i
                        class="bi bi-geo-alt-fill text-6xl text-gray-200 mb-6 block transform group-hover/map:scale-110 group-hover/map:rotate-12 transition-all duration-500"></i>
                    <h3 class="text-xl font-black text-gray-400 mb-2 uppercase tracking-widest leading-none">Mapa Interativo
                    </h3>
                    <p class="text-xs font-bold text-gray-400 italic">Visualize a presença da Life Church em Quelimane...
                    </p>
                </div>
                ...
                <div class="absolute top-10 right-10 flex flex-col gap-3">
                    <div
                        class="bg-white/80 backdrop-blur px-4 py-2 rounded-xl shadow-sm border border-gray-100 flex items-center gap-3">
                        <div class="w-2 h-2 rounded-full bg-blue-500 animate-pulse"></div>
                        <span class="text-[10px] font-black text-gray-500 uppercase tracking-widest">Norte: 12
                            Células</span>
                    </div>
                    <div
                        class="bg-white/80 backdrop-blur px-4 py-2 rounded-xl shadow-sm border border-gray-100 flex items-center gap-3">
                        <div class="w-2 h-2 rounded-full bg-purple-500 animate-pulse"></div>
                        <span class="text-[10px] font-black text-gray-500 uppercase tracking-widest">Centro: 25
                            Células</span>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div class="lg:col-span-2 bg-white rounded-3xl md:rounded-[2.5rem] shadow-sm border border-gray-100 p-5 md:p-8">
                <div class="flex items-center justify-between mb-6 md:mb-8">
                    <h3 class="text-lg md:text-xl font-black text-gray-900 tracking-tight">Crescimento de Membros</h3>
                    <span
            ...
            <div id="recent-activity"
                class="bg-white rounded-3xl md:rounded-[2.5rem] shadow-sm border border-gray-100 p-5 md:p-8">
                <h3 class="text-lg md:text-xl font-black text-gray-900 tracking-tight mb-6 md:mb-8">Atividade Recente</h3>
                <div class="space-y-5 max-h-[350px] overflow-y-auto pr-2 custom-scrollbar">
                        ...
                        <div class="flex items-start gap-4 group">
                            ...
                            <div class="flex-1 min-w-0 border-b border-gray-50 pb-4 group-last:border-0">
                                <div class="flex items-center justify-between mb-1">
                                    <p class="font-black text-gray-900 text-sm truncate">{{ $activity['title'] }}</p>
                                    <span
                                        class="text-[9px] font-bold text-gray-400 uppercase">{{ $activity['time']->diffForHumans() }}</span>
                                </div>
                    ...
                    @empty
                        <div class="flex flex-col items-center justify-center py-10 text-center">
                            ...
                            <p class="text-sm font-bold text-gray-400">Nenhuma atividade recente</p>
                        </div>
                    @endforelse
                </div>
            </div>
