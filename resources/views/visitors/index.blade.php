                    ...
                    <form id="bulkActionForm" method="POST">
                        ...
                        @forelse($visitors as $visitor)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <p class="text-sm font-bold text-gray-900">{{ $visitor->visit_date->format('d/m/Y') }}
                                    </p>
                    ...
                    timeout = setTimeout(function () {
                        ...
                        fetch(`${filterForm.action}?${params.toString()}`, {
                            ...
                            .then(html => {
                                ...
                                // Replace Pagination
                                // Note: Pagination might be outside these containers, check where it is.
                                // In original file, pagination is at bottom of file. 
                                // We should probably wrap the results in a container or replace a larger chunk.
