            ...
            <form method="POST" action="{{ route('visitors.update', $visitor) }}">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Status de Contato</label>
                            <select name="contact_status"
                                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent @error('contact_status') border-red-500 @enderror">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Célula</label>
                            <select name="cell_id"
                                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent @error('cell_id') border-red-500 @enderror">
                                <option value="">Selecione...</option>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div id="inviter_name_field" class="{{ old('invited_by_someone', $visitor->invited_by_someone) ? '' : 'hidden' }}">
                ...
                <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-100">
                    ...
                    <button type="submit"
                        ...
                        <i class="bi bi-check-lg mr-2"></i>Atualizar Visitante
                    </button>
                </div>
            </form>
        </div>
