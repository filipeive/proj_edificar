...
@section('content')
    <div class="w-full space-y-6">
        ...
        <div class="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div class="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
                    <div
                        class="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-700 text-white flex items-center justify-center text-2xl shadow-lg shadow-orange-100">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black text-gray-900 tracking-tight uppercase">Cadastrar Visitante</h1>
        ...
        <form method="POST" action="{{ route('visitors.store') }}" class="space-y-6 pb-8">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
                        <button type="submit"
                            class="w-full px-6 py-3.5 bg-gradient-to-r from-orange-600 to-orange-500 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] transform hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-orange-600/20 flex items-center justify-center gap-3">
