                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                @foreach($courseClass->coupleEnrollments as $couple)
                                    @php
                                        $attendance = $meeting->attendances->where('enrollable_type', \App\Models\CoupleEnrollment::class)->where('enrollable_id', $couple->id)->first();
                                        ...
                                        <td class="px-8 py-6">
                                            <div class="flex justify-center space-x-4">
                                                <label class="flex flex-col items-center cursor-pointer group">
                                                    <input type="radio" name="attendance[couple:{{ $couple->id }}]"
                                ...
                                @foreach($courseClass->courseEnrollments as $enrollment)
                                    ...
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td class="px-8 py-6">
                                            <div class="flex justify-center space-x-4">
                                                <label class="flex flex-col items-center cursor-pointer group">
                                                    <input type="radio" name="attendance[course:{{ $enrollment->id }}]"
                                                        value="present" {{ $currentStatus == 'present' ? 'checked' : '' }}
                                                        class="hidden peer">
                                                    <div
                                                        class="w-10 h-10 rounded-full border-2 border-gray-200 flex items-center justify-center text-gray-400 peer-checked:border-green-500 peer-checked:bg-green-500 peer-checked:text-white transition group-hover:border-green-200">
