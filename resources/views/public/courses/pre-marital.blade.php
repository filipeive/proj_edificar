    ...
    <div class="min-h-screen bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="max-w-3xl w-full space-y-8 relative z-10">
            <div class="text-center">
                ...
                <h2 class="text-4xl font-black text-white tracking-tighter">Inscrição: Curso Pré‑Marital</h2>
            ...
            <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-2xl">
                <form action="{{ route('public.forms.pre-marital.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="relationship_type" required
                                ...
                                <option value="namoro" class="bg-gray-900">Em relacionamento</option>
                                ...
                                <option value="casados" class="bg-gray-900">Casados</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="years_together_text"
                                class="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-4 text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition placeholder-gray-600"
