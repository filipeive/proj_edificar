...
@section('title', 'Editar Pacote - Portal Life Church')
@section('page-title', 'Editar Pacote')
@section('page-subtitle', 'Atualize as configurações do pacote ' . $package->name)
            ...
            <form action="{{ route('packages.update', $package) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="sms_template" id="sms_template" rows="2"
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('sms_template', $package->sms_template) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="whatsapp_template" id="whatsapp_template" rows="2"
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('whatsapp_template', $package->whatsapp_template) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <input type="url" name="whatsapp_link" id="whatsapp_link" placeholder="https://chat.whatsapp.com/..."
                        ...
                        value="{{ old('whatsapp_link', $package->whatsapp_link) }}">
                    @error('whatsapp_link')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select name="responsible_id" id="responsible_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 custom-select">
