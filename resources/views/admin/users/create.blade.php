                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="cell_id" id="cell_id"
                                        class="searchable-select w-full px-6 py-4 bg-gray-50 border-transparent focus:bg-white focus:ring-4 focus:ring-blue-100 rounded-2xl font-bold text-sm transition-all appearance-none cursor-pointer custom-select"
                                        data-label="Célula">
                        ...
                        <div class="space-y-6">
                            <div class="space-y-2">
                                ...
                                <select name="role" id="role" required
                                    ...
                                    <option value="tesouraria" {{ old('role') == 'tesouraria' ? 'selected' : '' }}
                                        class="bg-gray-900">Tesouraria</option>
                                    <option value="pastor" {{ old('role') == 'pastor' ? 'selected' : '' }}
