...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <form action="{{ route('reports.global') }}" method="GET"
            ...
            <div class="flex gap-2">
                <button type="submit"
                    class="w-full bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 font-medium">Filtrar</button>
                <a href="{{ route('reports.global') }}"
                    class="w-full text-center bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 font-medium">Limpar</a>
            </div>
        </form>
    </div>
    ...
    <div class="mb-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-lg font-bold text-gray-800 mt-2">{{ $startDate->format('d/m/Y') }} -
        ...
        <div class="flex flex-col gap-3">
            ...
            <a href="{{ route('reports.export.excel', ['type' => 'structure']) }}"
                class="w-full bg-blue-600 text-white px-4 py-3 rounded hover:bg-blue-700 text-center font-medium">
                <i class="bi bi-diagram-3"></i> Exportar Estrutura (Membros)
            </a>
        </div>
    </div>
